...
// import { useRouter } from "next/navigation" // Removed for React
...
export default function MasterpieceProjectsShowcase() {
  // const router = useRouter() // Removed for React
  const projects = getAllProjects()
  const [currentIndex, setCurrentIndex] = useState(0)
  const [isAutoPlaying, setIsAutoPlaying] = useState(true)
  const [direction, setDirection] = useState(0)
  const [isModalOpen, setIsModalOpen] = useState(false)
  // Removed unused isTransitioning state as it's not being used in the component
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 overflow-hidden">
      {/* Dynamic Background */}
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    <HeadingLarge as="h2" variant="elegant" className="mb-4 text-foreground leading-tight">
                  ...
                  >
                    <BodyLarge variant="elegant" className="text-muted-foreground leading-relaxed">
                ...
                >
                  <Caption variant="elegant" className="mb-4 text-brand-graphite_medium_text/60 dark:text-brand-moonstone_medium_text/60">
                    SERVICES PROVIDED
                  </Caption>
                ...
                >
                  ...
                  <BodyLarge variant="elegant" className="text-brand-graphite_medium_text dark:text-brand-moonstone_medium_text leading-relaxed">
        ...
        <motion.div
          className="flex items-center justify-between mt-12 md:mt-16 lg:mt-20"
